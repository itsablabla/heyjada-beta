...
describe('buildConfirmationSummary', () => {
    ...
    test('shell commands read as one intent sentence, with risk and file count as follow-ons', () => {
        ...
        expect(out).toContain('Superjoy wants to run a read-write shell command to clean the build directory.');
    ...
    test('edits name the file in spoken form', () => {
        ...
        expect(buildConfirmationSummary(r)).toContain('Superjoy wants to edit Tasks.org under the Documents/Notes folder.');
    });
    ...
    test('mcp tool calls speak the humanized tool name', () => {
        ...
        expect(buildConfirmationSummary(r)).toContain('Superjoy wants to use the github create issue tool.');
    });
...
describe('buildCompletionSummary', () => {
    ...
    test('long responses are trimmed with a pointer to the full result', () => {
        ...
        expect(out).toContain('Open Superjoy to read the full result.');
    ...
    test('caps at a paragraph break within the limit', () => {
        ...
        expect(out).toBe('Para one is short. … Open Superjoy to read the full result.');
    ...
    test('caps at a sentence end, not mid-word', () => {
        ...
        const out = buildCompletionSummary(text);
        expect(out).toBe('Alpha. Beta. … Open Superjoy to read the full result.');
