# <img src="src/client/public/icons/superjoy_64.png" width="28" height="28" alt="Superjoy logo" /> Superjoy (Beta)

[![Download Superjoy](https://img.shields.io/badge/Download_Superjoy-%E2%86%93-1a1a1a?style=for-the-badge&labelColor=1a1a1a&color=525252)](https://github.com/itsablabla/heyjada-beta/releases)
...
### Work Async
Assign Superjoy a few tasks and go grab a coffee. Track progress, give feedback and get notified when Superjoy needs your attention.
...
Ask Superjoy to create [skills](https://agentskills.io/) for all your custom workflows - where to find project documents, which accounting method to follow or your email organization policy.

### Connect your tools
Integrate Jira, Linear, Slack etc. via MCP. Superjoy can create issues, post messages, and interact with external APIs on your behalf.

### Use your favorite AI models
Use the right AI model for the right task. Model access is provided through the Superjoy Platform — Single Sign On, no API key setup needed.

### Run safely
Superjoy runs commands safely in a local sandbox that restricts file and network access. This reduces your confirmation fatigue while it works safely on your computer.
...
3. Assign Superjoy a task

## Run on a Remote Server (Web App)

Superjoy can run headless on a server and be used from any browser — and installed as a Web App (PWA).
...
- **Install as a Web App** — open Superjoy in your browser and use "Install app" (Chrome/Edge) or "Add to Home Screen" (iOS/Android). The served web manifest gives you a standalone app window with the Superjoy icon.
- **HTTPS** — for remote access, put Superjoy behind a TLS reverse proxy (e.g. Caddy or nginx); browsers require a secure context to install the Web App and to keep Basic Auth credentials safe.
...
- **Do I need API keys?**<br />
  No — model access is provided via the Superjoy Platform.
