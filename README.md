# <img src="src/client/public/icons/pipali_64.png" width="28" height="28" alt="Super Joy logo" /> Super Joy (Beta)

[![Download Super Joy](https://img.shields.io/badge/Download_Super_Joy-%E2%86%93-1a1a1a?style=for-the-badge&labelColor=1a1a1a&color=525252)](https://github.com/itsablabla/heyjada-beta/releases)
...
### Work Async
Assign Super Joy a few tasks and go grab a coffee. Track progress, give feedback and get notified when Super Joy needs your attention.
...
Ask Super Joy to create [skills](https://agentskills.io/) for all your custom workflows - where to find project documents, which accounting method to follow or your email organization policy.

### Connect your tools
Integrate Jira, Linear, Slack etc. via MCP. Super Joy can create issues, post messages, and interact with external APIs on your behalf.

### Use your favorite AI models
Use the right AI model for the right task. Model access is provided through the Super Joy Platform — Single Sign On, no API key setup needed.

### Run safely
Super Joy runs commands safely in a local sandbox that restricts file and network access. This reduces your confirmation fatigue while it works safely on your computer.
...
3. Assign Super Joy a task

## Run on a Remote Server (Web App)

Super Joy can run headless on a server and be used from any browser — and installed as a Web App (PWA).
...
- **Install as a Web App** — open Super Joy in your browser and use "Install app" (Chrome/Edge) or "Add to Home Screen" (iOS/Android). The served web manifest gives you a standalone app window with the Super Joy icon.
- **HTTPS** — for remote access, put Super Joy behind a TLS reverse proxy (e.g. Caddy or nginx); browsers require a secure context to install the Web App and to keep Basic Auth credentials safe.
...
- **Do I need API keys?**<br />
  No — model access is provided via the Super Joy Platform.
