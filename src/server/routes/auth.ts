...
<html>
<head>
    <title>Super Joy - Completing Authentication</title>
...
<body>
    <header class="page-header">
        <div class="brand">
            <img src="/icons/pipali_128.png" alt="Super Joy" />
            <span class="app-name">Super Joy</span>
        </div>
    </header>
    <main class="main-content">
        ...
        <div class="card success" id="success">
            ...
            <p class="subtitle">Returning you to the Super Joy app. You can close this tab once it's in focus.</p>
            <a href="pipali://auth/callback" class="btn" id="open-app">Open Super Joy</a>
        </div>
    </main>
    <script>
        (function() {
            ...
            .then(data => {
                if (data.success) {
                    if (data.desktopAuth) {
                        ...
                        // The "Open Super Joy" button is a fallback if the browser blocks
...
<html>
<head>
    <title>Super Joy - Authentication Failed</title>
    <link rel="icon" type="image/png" href="/icons/pipali_64.png">
    <link rel="apple-touch-icon" href="/icons/pipali_128.png">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <style>
