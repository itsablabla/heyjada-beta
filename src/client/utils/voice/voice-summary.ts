...
/**
 * The operation as a spoken verb phrase completing "Jada wants to …".
 ...
 * — "Jada wants to edit X." — then the deterministic facts (risk, file
...
export function buildConfirmationSummary(req: ConfirmationRequest, spokenDetail?: string): string {
    ...
    const parts: string[] = [intent ? `Jada wants to ${intent}.` : req.title];
