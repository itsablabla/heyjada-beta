...
/**
 * The operation as a spoken verb phrase completing "Pipali wants to …".
 ...
 * — "Pipali wants to edit X." — then the deterministic facts (risk, file
...
export function buildConfirmationSummary(req: ConfirmationRequest, spokenDetail?: string): string {
    ...
    const parts: string[] = [intent ? `Pipali wants to ${intent}.` : req.title];
